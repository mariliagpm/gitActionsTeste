...
namespace roomstogoseleniumframework.PageObjects
{
    public class ProductPage
    {
        ...
        public void ValidateKidsLaborDaySaleHeader()
        {
            ...
            ClassicAssert.IsNotNull(kidsLaborDaySaleHeader, "The 'Kids Labor Day Sale' header does not exist.");
            ClassicAssert.AreEqual("Kids Labor Day Sale", kidsLaborDaySaleHeader.Text, "The header text does not match 'Kids Labor Day Sale'.");
        }
        ...
        public void ValidateSalesTabIsActive()
        {
            ...
            ClassicAssert.IsTrue(isActive, "The 'Sales' tab is not active.");
        }
